...
describe('Notifications schema tests', () => {
  test('normalized data has the correct result array', () => {
  ...
  test('normalized data has the correct users entity', () => {
  ...
  test('normalized data has the correct messages entity', () => {
  ...
  test('normalized data has the correct notifications entity', () => {
